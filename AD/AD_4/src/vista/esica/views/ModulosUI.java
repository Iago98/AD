...
public abstract class ModulosUI {
	...
	/**
	 * En este m√©todo deben recuperarse todos los ciclos que se deseen mostrar en el combo Ciclos y 
	 * agregarlos empleando el m√©todo addCiclo(id,nombre)
	 */
	...
	private void initialize() {
		...
		btnEliminar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				if(id!=null){
					int res = JOptionPane.showConfirmDialog(null, "El mÛdulo "+getNombre()+" se eliminar· de forma permanente","Eliminar",JOptionPane.OK_CANCEL_OPTION);
	...
	private void verAlumnosDeModulo(){
		...
		JOptionPane.showMessageDialog(null, "Esta funcionalidad a˙n no est· implementada. Disculpe las molestias");
	}
